...
3. You run a generated script against your **ADaM datasets**, and the result is an **ARD** - one row per result, ready for downstream use.
...
| _methods_ | Describes the operations to perform, and carries the dynamic R code template _siera_ fills in. |
