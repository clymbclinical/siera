...
json_path <- ARS_example("exampleARS_1.json")
...
Before starting out with this example, it would be helpful to first have a discussion on the composition of the ARS metadata, and the use of `cards` functions.  
