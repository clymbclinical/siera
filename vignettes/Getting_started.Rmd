...
An example of such an auto-generated ARD script is included in the package, and can be used by using the `ARD_script_example` function. Running this script will look like this:
