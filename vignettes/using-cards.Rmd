...
# the method-template library that ships with siera:
lib <- system.file("method-library", package = "siera")

# the authoritative list of constructs (valueSources) siera resolves:
file.path(lib, "constructs.json")

# a human-readable catalog of the available method templates:
