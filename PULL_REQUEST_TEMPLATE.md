...
run — examples render and new functions appear on the Reference page

`NEWS.md` updated, if this touches an exported function or user-facing
docs
...
Example ARS metadata still generates scripts that run against the ADaM
data
